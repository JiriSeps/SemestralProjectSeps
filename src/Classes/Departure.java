...
public class Departure {
    ...
    //constructor 02
    public Departure(String flightNumber, int day, int month, int year, String departureAirport, String destinationAirport, String departureTime, String arrivalTime) {
    ...
    public void setDepartureDate(int day, int month, int year) {             
        SimpleDateFormat sdf = new SimpleDateFormat("d MMM yyyy");     //define date format
        Calendar calendar1 = new GregorianCalendar(year, month-1, day);   //calendar class date creation   
    ...
    public void setDepartureTime(int hour, int minute) {
        SimpleDateFormat sdf = new SimpleDateFormat("HH:mm ");     //define date format
        Calendar calendar1 = new GregorianCalendar(2016, 12, 5, hour, minute);   //calendar class date creation  
